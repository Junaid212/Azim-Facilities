...
Join our satisfied clients and experience the difference today.</p>
              ...
              <div className="col-xl-12 col-xxl-6 text-center text-xl-start">
                  <div className="about-feature-wrap">
                      <div className="about-feature">
                          ...
                          <div className="box-content">
                           <span className="sub-title2 style1">Comprehensive </span>
                              <h1 className="sec-title text-white">Cleaning and Housekeeping services for star-rated facilities</h1>
                      ...
                      <div className="about-feature">
                          ...
                          <div className="box-content">
                              <h3 className="box-title">Exterior Building Cleaning</h3>
                              <p className="box-text">Professional cleaning of building exteriors to remove dirt, grime, and 
                                environmental pollutants. This service enhances the building’s appearance and helps maintain
                                 its structural integrity.</p>
                          </div>
                      </div>
                      <div className="about-feature">
                          <div className="box-icon">
                          ...
                          <div className="box-content">
                              <h3 className="box-title">Deep Interior Cleaning</h3>
                              <p className="box-text">Comprehensive deep cleaning of interiors, including scrubbing, sanitizing,
                                 and decluttering. Ensures the removal of dirt, dust, and grime, leaving spaces spotless and hygienic.</p>
                          </div>
                      </div>
                      <div className="about-feature">
                          <div className="box-icon">
                          ...
                          <div className="box-content">
                              <h3 className="box-title">Hygiene & Cleaning Services for Hotels and Residences</h3>
                              <p className="box-text">Specialized cleaning and hygiene solutions designed for hotels and residential
                                 properties. Delivering tailored services that ensure exceptional cleanliness, guest satisfaction, 
                                 and resident comfort.</p>
                          </div>
                      </div>
                  </div>
              </div>
