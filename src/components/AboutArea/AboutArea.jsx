          ...
          <div className="row gy-40 align-items-center">
              <div className="col-lg-6 col-xxl-4">
                  <div className="title-area mb-30 pe-xxl-5">
                      ...
                      <p className="text-body fs-18 mt-25 mb-40">We are an ISO 9001:2015 certified company with full compliance to Sedex 
                        Smeta 4-pillar guidelines, stands as a leading player in the realm of facilities management & Hospitality in Qatar.
                         With a heightened demand for quality services in the thriving hospitality and hotel industries, Azim Facilities
                          Management & Hospitality Services emerges as a pivotal solution provider.</p>
                      <p className="text-body fs-18 mb-60">Our unwavering commitment to excellence, coupled with highly skilled and adept
                         workforce, positions us as a premier choice for comprehensive facility management & Hospitality services</p>
                  </div>
