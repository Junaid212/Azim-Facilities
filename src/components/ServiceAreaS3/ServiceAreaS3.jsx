...
const ServiceAreaS3 = () => {
  ...
  return (
    <section className="service-area3 overflow-hidden bg-shape space">
      <div className="container">
        ...
        <div className="row gy-4">
          {ServiceData.slice(0, 6).map((item, index) => (
            <div className="col-md-6 col-xl-4 col-xxl-4 d-flex" key={index}>
              <div
                className="service-box flex-fill"
                ...
                style={{
                  ...
                  borderRadius: '10px',
                  height: '100%', // ensures equal height within flex grid
                  display: 'flex',
